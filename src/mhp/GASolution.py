...
class GASolution:
    ...
    def print(self, mode = 'full', plotFitness = False, printDroneNet = False, show_exact = True):
        if mode == 'full':
            print('= GENETIC ================================')
            print("Time : {first_time}/{execution_time} ms".format(first_time=int(1000*self.first_time), execution_time=int(1000*self.time)))
            ...
            print(int(1000*self.first_time), end=';')
