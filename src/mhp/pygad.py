...
class GA:
    ...
    def roulette_wheel_selection(self, fitness, num_parents):
        ...
        probs_start = numpy.zeros(probs.shape, dtype=numpy.float64) # An array holding the start values of the ranges of probabilities.
        probs_end = numpy.zeros(probs.shape, dtype=numpy.float64) # An array holding the end values of the ranges of probabilities.
