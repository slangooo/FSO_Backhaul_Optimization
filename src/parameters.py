...
MBS_LOCATIONS = [
    ...
    Coords3d(X_BOUNDARY[0], Y_BOUNDARY[1], MBS_HEIGHT), # PW add
    Coords3d(X_BOUNDARY[1], Y_BOUNDARY[0], MBS_HEIGHT), # PW add
...
CALCULATE_EXACT_FSO_NET_SOLUTION_INSTANCE_LIMIT = 10000
...
FSO_NET_GENECTIC_ALGORITHM_GENERATION_LIMIT = 1000
